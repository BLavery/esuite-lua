...
gpio.mode(15,1)
gpio.write(15,math.floor(node.random()*2 % 2))  -- random 0 or 1
...
-- SETUP:  
--    MCP23017 strapped as address 0x20 (VDD=RST*=+3.3, VSS=gnd, SCL-D1, SDA-D2, A0=A1=A2=gnd)
...
-- Total 5 wires to ESP8266: D1 D2 +3.3 Gnd and A0
