-- This file creates a font array to file "|char8x8" for using 8x8 MAX7219 module. 
-- This font is 5x7 but placed in 8x8 frame.

print("Create 5x7 font into 8x8 character file")
print(node.heap())
local font5x7={    
...
for c=1 , 128 do
    ...
    for k=1, 6 do
        file.write(string.char(font5x7[c][k]))
    end
    file.write(string.char(0))
end
file.close()
